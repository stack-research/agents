...
- `make test-security` runs ASI01+ASI02+ASI03 adversarial regression tests and scanner tests.
- `make test-security-llm` runs ASI01+ASI02+ASI03 adversarial tests against local Ollama.
