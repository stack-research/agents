...
- `make test-security` runs ASI01+ASI02 adversarial regression tests and scanner tests.
- `make test-security-llm` runs ASI01+ASI02 adversarial tests against local Ollama.
