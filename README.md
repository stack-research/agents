...
- `make test`
- `make test-security` (ASI01+ASI02+ASI03+ASI04+ASI05+ASI06+ASI07 adversarial checks + scanner tests)
- `make test-security-llm` (ASI01+ASI02+ASI03+ASI04+ASI05+ASI06+ASI07 adversarial checks against local LLM)
